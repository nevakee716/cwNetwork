...
(function(cwApi, $) {
  ...
  cwLayoutNetwork.prototype.construct = function(options) {
    ...
    this.originalOptions.ctxNodesString = this.options.CustomOptions["contextualFilter"];
    this.originalOptions.IncludeOnlyIfHasAssociationsString = this.options.CustomOptions["IncludeOnlyIfHasAssociationsNode"];
    this.originalOptions.filterByBaseObject = this.options.CustomOptions["filterByBaseObject"];

    this.multiLineCount = this.options.CustomOptions["multiLineCount"];
    this.getOption("complementaryNode", "complementaryNode", ",");
    this.getOption("IncludeOnlyIfHasAssociationsNode", "IncludeOnlyIfHasAssociationsNode", ",");
    this.getOption("filterByBaseObject", "filterByBaseObject", ",");
    ...
    if (this.physConfiguration !== "") {
      ...
      this.physConfiguration = {
        barnesHut: { gravitationalConstant: -26500, springLength: 150 },
        minVelocity: 0.75,
      };
