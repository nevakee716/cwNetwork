...
(function(cwApi, $) {
  ...
  cwLayoutNetwork.prototype.getConfigurationAndAssociationObjectToNetwork = function(newObj, networkLabel) {
    ...
    config.clusterByGroupOption = this.clusterByGroupOption;
  ...
  cwLayoutNetwork.prototype.loadCwApiNetwork = function(config) {
    ...
    if (this.clusterOption) {
      this.clusterByGroupOption = config.clusterByGroupOption ? config.clusterByGroupOption : [];
      this.fillValueInClusterFilter(config.clusterByGroupOption);
      this.clusterByGroup();
    ...
    //if (false && config.physics) this.networkUI.physics.options = config.physics;
