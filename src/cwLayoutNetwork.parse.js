...
(function(cwApi, $) {
  ...
  cwLayoutNetwork.prototype.drawAssociations = function(output, associationTitleText, object) {
    try {
      if (cwApi.customLibs.utils === undefined || cwAPI.customLibs.utils.version === undefined || cwAPI.customLibs.utils.version < 1.9) {
        output.push("<h2> Please Install Utils library 1.9 or higher</h2>");
        return;
      }
